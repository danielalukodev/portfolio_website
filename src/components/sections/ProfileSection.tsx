      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 space-y-4">
          <div className="bg-[#1a1a1c] border border-[#2a2a2c] rounded-xl p-5">
            <h2 className="text-xl font-bold text-white mb-1">Daniel Clarke</h2>
            <p className="text-sm text-gray-400 mb-3">Junior Web Developer</p>
            <p className="text-sm text-gray-300 italic">
              Junior web developer learning React and modern frontend tools. I
